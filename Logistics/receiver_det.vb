...
Public Class receiver_det
    Private Sub receiver_det_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        BackCol()
        fetchCity()
    ...
    Public Sub BackCol()
        ...
        Label12.BackColor = Color.FromArgb(0, 36, 199)
    ...
    Private Sub Guna2Button1_Click(sender As Object, e As EventArgs) Handles Guna2Button1.Click
        ...
        If name = "" Or address = "" Or city = "" Or email = "" Then
        ...
        Else
            ...
            cmd.CommandText = "insert into receiver_det (p_id, u_id, name,email, phone, address, city, pin) values (" & pid & "," & uid & ",@name,@email, @phone, @address, @city, @pin)"
            ...
            con.Close()
            Me.Close()
            MsgBox("Receiver added Successfully")
            payment.Show()
        End If
    End Sub
